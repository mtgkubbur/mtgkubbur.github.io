...
# Use ALL matches for calculations (so h2h records count games vs
# non-opted-in players), but only display opted-in players in selectors.
...
# Player list for selectors: only opted-in players (Icelandic sort)
