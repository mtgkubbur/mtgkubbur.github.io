...
//| label: elo-diff-chart
{
  ...
  const chart = Plot.plot({
    ...
    marks: [
      ...
      Plot.areaY(eloDiff, {
        x: "date", y1: 0, y2: d => Math.max(0, d.diff), fill: themeColors.green, fillOpacity: isDark ? 0.25 : 0.3, curve: "monotone-x"
      }),
      Plot.areaY(eloDiff, {
        x: "date", y1: 0, y2: d => Math.min(0, d.diff), fill: themeColors.red, fillOpacity: isDark ? 0.25 : 0.3, curve: "monotone-x"
      }),
      Plot.lineY(eloDiff, { x: "date", y: "diff", stroke: themeColors.line, strokeWidth: 1.5, curve: "monotone-x" }),
